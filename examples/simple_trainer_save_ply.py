...
class Runner:
    ...
    def train(self):
        ...
        for step in pbar:
            ...
            if step in [i - 1 for i in cfg.eval_steps]:
                ...
                self.save_ply(os.path.join(self.cfg.result_dir, "point_cloud/iteration_{}.ply".format(step)))
    ...
    def eval(self, step: int, stage: str = "val"):
        ...
        ellipse_time = 0
        metrics = {"psnr": [], "cc_psnr": [], "ssim": [], "cc_ssim": [], "lpips": [], "cc_lpips": []}
        ...
        if world_rank == 0:
            ...
            print(
                f"PSNR: {psnr.item():.3f}, CC_PSNR: {cc_psnr.item():.3f}, SSIM: {ssim.item():.4f}, CC_SSIM: {cc_ssim.item():.4f}, LPIPS: {lpips.item():.3f}, CC_LPIPS: {cc_lpips.item():.3f} "
    ...
    def run_compression(self, step: int):
        ...
        self.save_ply(path=f'{cfg.result_dir}/compressed_splats_MCMC.ply')
...
def main(local_rank: int, world_rank, world_size: int, cfg: Config):
    ...
    if cfg.ckpt is not None:
        ...
        runner.save_ply(path=f'{cfg.result_dir}/splats_MCMC.ply')
        if cfg.compression is not None:
